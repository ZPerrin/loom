...
Each spec's Purpose says what the operator gets and its Non-goals name the neighbors; the six skills
are prose and have no spec.
...
for ids that other repos or tests still name. A ruling the operator gives in the fence counts as the
operator typing it, and the report says which lines were transcribed.
