...
### R-DEMO-001: Repeated behavior
WHEN a user repeats the action, the system SHALL record the result within 1 second.
#### Scenario: repeat -> test_example_repeat
- GIVEN a ready system
- WHEN the user repeats the action
- THEN the result is recorded
